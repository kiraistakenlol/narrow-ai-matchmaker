...
export class AwsTranscribeService {
    ...
    async transcribeAudio(s3Key: string, languageCode: LanguageCode | string = LanguageCode.EN_US): Promise<string> {
        ...
        try {
            ...
            return 'Hi, I'm Olivia Parker, founder of HealthTrack, a health monitoring app that helps users track and analyze their wellness data. I have a business background and a clear vision for the product but I'm looking for a technical co-founder who can build and lead our tech stack. My app idea has received positive feedback from early testers, but I need a skilled engineer to turn this vision into reality.'
