...
function ScenariosPage() {
    ...
    return (
        <div className="scenarios-page" style={{padding: '20px', fontFamily: 'sans-serif'}}>
            <h2 style={{borderBottom: '1px solid #eee', paddingBottom: '10px', marginBottom: '20px'}}>Match
                Scenarios</h2>
                ...
                <div key={category} className="scenario-category" style={{marginBottom: '30px'}}>
                    ...
                    <ul style={{listStyle: 'none', padding: 0}}>
                        {scenarioList.map(scenario => {
                            const genStatus = generationStatus[scenario.id] || {
                                isLoading: false,
                                error: null,
                                filePath: null,
                                message: null
                            };
                            const embedStatus = embeddingStatus[scenario.id] || {
                                isLoading: false,
                                error: null,
                                message: null
