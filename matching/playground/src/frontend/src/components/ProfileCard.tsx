...
import {Engagement, Profile, HardSkillEntry, Role, SoftSkillEntry} from 'narrow-ai-matchmaker-common';
    ...
    return (
        <li style={cardStyle}>
            ...
            <div style={detailStyle}>
                <strong style={labelStyle}>Hard
                    Skills:</strong> {formatArray(profile.skills?.hard?.map((s: HardSkillEntry) => s.skill))}
            </div>

            {/* Skills - Soft */}
            <div style={detailStyle}>
                <strong style={labelStyle}>Soft
                    Skills:</strong> {formatArray(profile.skills?.soft?.map((s: SoftSkillEntry) => s.skill))}
            </div>
            ...
            <div style={{fontSize: '0.9em'}}>
                <strong style={labelStyle}>Looking
                    for:</strong> {formatArray(profile.event_context?.goals?.looking_for)}
                <br/>
